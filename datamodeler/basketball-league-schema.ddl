...
ALTER TABLE pravanaigraca
    ADD CONSTRAINT pravnaigr_bira_fk FOREIGN KEY ( idregrut,
                                                   idpik )
...
ALTER TABLE predmettrgovine
    ADD CONSTRAINT predtrg_zahtzatrg_fk FOREIGN KEY ( idzahtrg )
...
ALTER TABLE ugovor
    ADD CONSTRAINT ugovor_tipug_fk FOREIGN KEY ( idtipugo )
