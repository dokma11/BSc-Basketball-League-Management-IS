...
CREATE TABLE draft (
    ...
    lokodrdraft VARCHAR2(128 CHAR) NOT NULL
);
...
CREATE TABLE intervju (
    ...
    mesodrint VARCHAR2(128 CHAR) NOT NULL,
    datvreint DATE NOT NULL,
    belesint  VARCHAR2(256 CHAR),
...
CREATE TABLE pozivnaintervju (
    idpozint     INTEGER NOT NULL,
    mesodrpozint VARCHAR2(128 CHAR) NOT NULL,
    datvrepozint DATE NOT NULL,
    statuspozint VARCHAR2(10) NOT NULL,
    razodbpozint VARCHAR2(128 CHAR),
    idregrut     INTEGER,
...
CREATE TABLE pozivnatrening (
    ...
    mesodrpoztrng VARCHAR2(128 CHAR) NOT NULL,
    statuspoztrng VARCHAR2(10) NOT NULL,
    razodbpoztrng VARCHAR2(128 CHAR),
    idtrener      INTEGER NOT NULL,
    trajtrng      VARCHAR2(3 CHAR) NOT NULL,
    naztiptrng    VARCHAR2(64 CHAR) NOT NULL
);
...
CREATE TABLE tiptreninga (
    ...
    naztiptrng  VARCHAR2(64 CHAR) NOT NULL,
    ciljtiptrng VARCHAR2(128 CHAR) NOT NULL
);
...
CREATE TABLE trening (
    ...
    mesodrtrng VARCHAR2(128 CHAR) NOT NULL,
    belestrng  VARCHAR2(256 CHAR),
    idtiptrng  INTEGER NOT NULL,
    idpoztrng  INTEGER NOT NULL
);
...
CREATE TABLE trgovina (
    ...
    zahtevzatrgovinu_idzahtrg INTEGER NOT NULL
);
...
CREATE TABLE zeljatima (
    ...
    beleszeljtim  VARCHAR2(256 CHAR),
    idtipzelje    INTEGER NOT NULL,
    idpik         INTEGER,
    idigrac       INTEGER,
    idtim         INTEGER NOT NULL,
...
ALTER TABLE intervju
    ADD CONSTRAINT intervju_poznaint_fk FOREIGN KEY ( idpozint )
...
ALTER TABLE pozivnaintervju
    ADD CONSTRAINT poznaint_regrut_fk FOREIGN KEY ( idregrut )
        REFERENCES regrut ( id );

ALTER TABLE pozivnaintervju
    ADD CONSTRAINT poznaint_trener_fk FOREIGN KEY ( idtrener )
        REFERENCES trener ( id );

ALTER TABLE pozivnatrening
    ADD CONSTRAINT poznatrng_trener_fk FOREIGN KEY ( idtrener )
        REFERENCES trener ( id );
...
ALTER TABLE pravanaigraca
    ADD CONSTRAINT pravnaigr_tim_fk FOREIGN KEY ( idtim )
        REFERENCES tim ( idtim );
...
ALTER TABLE trening
    ADD CONSTRAINT trening_poznatrng_fk FOREIGN KEY ( idpoztrng )
...
ALTER TABLE trgovina
    ADD CONSTRAINT trgovina_zahzatrg_fk FOREIGN KEY ( zahtevzatrgovinu_idzahtrg )
        REFERENCES zahtevzatrgovinu ( idzahtrg );
...
ALTER TABLE zahtevzatrgovinu
    ADD CONSTRAINT zahzatrg_menadzer_fk FOREIGN KEY ( idmenadzerprim )
        REFERENCES menadzer ( id );

ALTER TABLE zahtevzatrgovinu
    ADD CONSTRAINT zahzatrg_menadzer_fkv1 FOREIGN KEY ( idmenadzerpos )
        REFERENCES menadzer ( id );
...
ALTER TABLE zeljatima
    ADD CONSTRAINT zeljatima_pravnaigr_fk FOREIGN KEY ( idprava )
        REFERENCES pravanaigraca ( idprava );

ALTER TABLE zeljatima
    ADD CONSTRAINT zeljatima_regrut_fk FOREIGN KEY ( idregrut )
        REFERENCES regrut ( id );
